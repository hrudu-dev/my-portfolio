// Main JavaScript for Hrudu Shibu Portfolio
...
function initScrollAnimations() {
    const animateElements = document.querySelectorAll('.timeline-item, .tech-item, .education-item, .contact-item');
...
window.addEventListener('scroll', debounce(addRevealAnimation, 10));
